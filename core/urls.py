...
urlpatterns = [
    ...
    path('test-results/<int:pk>/writing-feedback-status/', views.writing_feedback_status, name='writing_feedback_status'),
    path('test-results/<int:pk>/answer-explanation-status/', views.answer_explanation_status, name='answer_explanation_status'),
