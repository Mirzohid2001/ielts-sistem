...
class Question(models.Model):
    ...
    def get_user_answer_display(self, user_answer):
        ...
        return options.get(user_answer, '')
...
class UserTestAnswer(models.Model):
    ...
    user_answer = models.CharField(max_length=1, choices=[('a', 'A'), ('b', 'B'), ('c', 'C'), ('d', 'D')], verbose_name="Foydalanuvchi javobi")
    ...
    def check_answer(self):
        """Javobni tekshirish"""
        self.is_correct = self.user_answer.lower() == self.question.correct_answer.lower()
        self.save()
